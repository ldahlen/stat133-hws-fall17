...
salary[seq(2,length(player),2)]
team[seq(5,length(player),5)]
points[seq(10,length(player),10)]
rev(player[seq(1,length(player),2)])
```
...
log_warriorspoints <- log(warriors_points)
log_warriorssalary <- log(warriors_salary)
plot(log_warriorspoints,log_warriorssalary)
text(log_warriorspoints, log_warriorssalary, labels = abbreviate(player))
```
...
```{r}
salary_millions <- salary*(1/1000000)
salary_millions
```
